...
namespace SampleRegression.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Dev\TorontoBeachPredictor\mlnet\beach.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.EColiCount0} | Predicted value: {predictionResult.Score}");
